...
public class SensorManager {
    ...
    private SensorManager() throws Exception {
        ...
        if (pairedDevices.size() > 0) {
            for (BluetoothDevice device : pairedDevices) {
                if (device.getName().contains("YostLabsMBT")
                        || device.getName().contains("YEI_3SpaceBT")
                        || device.getName().contains("YEI-3SpaceBT")
                        || device.getName().contains("Yost_3SpaceBT")
                        || device.getName().contains("Yost-3SpaceBT")) {
    ...
    public static SensorManager getInstance() throws Exception {
